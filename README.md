...
Ludusavi's config is located at `C:\Users\_YOUR_USERNAME_\AppData\Roaming\ludusavi\config.yaml`, take this file from the 1st computer with the save files onto the 2nd computer you are setting up for a faster setup.
